...
try:
    client.collections["Mark's TEI"].delete()
...
for x in tqdm(files, total=len(files)):
    ...
    for v in facs:
        ...
        cfts_record["resolver"] = f"https://github.com/markedwinpeterson/dse_static_cookiecutter/dse-static/{record['id']}"
...
print(make_index)
print("done with indexing Mark's TEI")

make_index = CFTS_COLLECTION.documents.import_(cfts_records, {"action": "upsert"})
print(make_index)
print("done with cfts-index Mark's TEI")
